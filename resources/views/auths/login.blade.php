...
.mdl-layout__content {
  ...
  @yield('style')
  <title>Jalma @yield('title')</title>
</head>

<body>

<div class="mdl-layout mdl-js-layout mdl-color--pink ">
  ...
  <div class="card-body">
    ...
    <form class="form-auth-small" action="/postlogin" method="POST">
      {{ csrf_field() }}
        ...
        <button tyoe="submit" class="btn mdl-button mdl-js-button mdl-button--raised mdl-button--colored btn-block">
            Masuk
        </button>
    </form>
  </div>
